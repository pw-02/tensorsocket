...
_logger = logging.getLogger("tensorshare")
_logger.setLevel("CRITICAL")

_logger = logging.getLogger("tensorsocket")
_logger.setLevel("CRITICAL")
...
group.add_argument("--use-shared-loader", action="store_true", default=False)
group.add_argument(
    "--synchronize-step",
    action="store_true",
    default=False,
...
if __name__ == "__main__":
    ...
    if not args.skip_validation:
        dataset_eval = create_dataset(
            ...
            # split=args.train_split, # TODO: make validation work on the 1%, 10% imagenet subsets
            # so we dont have to run validation over full imagenet dataset size
            is_training=False,
            class_map=args.class_map,
            download=args.dataset_download,
            batch_size=args.batch_size,
    ...
    train_producer = TensorProducer(
        train_loader, "5556", "5557", heart_ports=(4444, 4445)
    )
